        ...
        <div class="col-md-2">
            <ul class="nav nav-pills nav-stacked space-nav">
                @if(Auth()->check() && Auth()->user()->id === $userInfo->id)
                    ...
                    <li @if(request()->route()->getName() == 'auth.space.links') class="active" @endif ><a href="{{ route('auth.space.links',['user_id'=>$userInfo->id]) }}">我的链接</a></li>
                    <li @if(request()->route()->getName() == 'auth.space.links') class="active" @endif>
                      <a href="{{ route('auth.space.links',['user_id'=>$userInfo->id]) }}">我的提问</a>
                    </li>
                    <li @if(request()->route()->getName() == 'auth.space.articles') class="active" @endif ><a href="{{ route('auth.space.links',['user_id'=>$userInfo->id]) }}">我的文章</a></li> 
                    ...
                    <li @if(request()->route()->getName() == 'auth.space.exp') class="active" @endif ><a href="{{ route('auth.space.exp',['user_id'=>$userInfo->id]) }}">我的经验</a></li>
                ...
                @else
                    ...
                    <li @if(request()->route()->getName() == 'auth.space.links') class="active" @endif ><a href="{{ route('auth.space.links',['user_id'=>$userInfo->id]) }}">他的回答</a></li>
                    <li @if(request()->route()->getName() == 'auth.space.links') class="active" @endif ><a href="{{ route('auth.space.links',['user_id'=>$userInfo->id]) }}">他的提问</a></li>
                    <li @if(request()->route()->getName() == 'auth.space.links') class="active" @endif ><a href="{{ route('auth.space.links',['user_id'=>$userInfo->id]) }}">他的文章</a></li>
                    <li role="separator" class="divider"><a></a></li>
                    ...
                    <li @if(request()->route()->getName() == 'auth.space.exp') class="active" @endif ><a href="{{ route('auth.space.exp',['user_id'=>$userInfo->id]) }}">他的经验</a></li>
